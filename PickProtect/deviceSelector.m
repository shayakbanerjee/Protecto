...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"PickProtect Device"];
...
-(NSString *) tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    if (section == 0) {
        if (self.sensorTags.count > 1 )return [NSString stringWithFormat:@"%d PickProtect Devices Found",self.sensorTags.count];
        else return [NSString stringWithFormat:@"%d PickProtect Device Found",self.sensorTags.count];
    }
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    TraqBasicViewController *rrC = [[TraqBasicViewController alloc] init:d];
    //PocketMaarViewController *rrC = [[PocketMaarViewController alloc] init:d];
